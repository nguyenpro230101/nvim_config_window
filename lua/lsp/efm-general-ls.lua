...
local prettier = {formatCommand = "prettier.cmd --stdin-filepath ${INPUT}", formatStdin = true}
...
require"lspconfig".efm.setup {
    ...
    filetypes = {"python", "javascriptreact", "javascript", "typescript", "typescriptreact", "html", "css", "json", "yaml", "vue"},
    settings = {
        rootMarkers = {".git/"},
        languages = {
